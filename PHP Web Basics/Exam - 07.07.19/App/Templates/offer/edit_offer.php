...
<form method="post">
    ...
    Is Occupied: <input type="checkbox" value="<?= $data->getOffer()->getIsOccupied(); ?>" name="is_occupied"><br/>
    <input type="submit" name="edit" value="Edit Offer"/>
</form>
<a href="my_offers.php">Back</a>